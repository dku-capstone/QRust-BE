package com.qrust.exception.qrcode;

public class ErrorMessages {

    public static final String KEY_NOT_VALID = "유효하지 않은 키입니다.";
    public static final String IMAGE_UPLOAD_FAIL = "QR 코드 이미지 업로드 실패";
    ...
    public static final String INVALID_SECRET_KEY = "필수 환경 변수 'CRYPTO_AES_KEY'가 설정되지 않았거나 비어 있습니다.";
